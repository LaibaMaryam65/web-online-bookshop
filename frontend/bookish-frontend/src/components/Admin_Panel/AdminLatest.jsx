...
export default function AdminLatest() {
  ...
  async function handleAdd(book) {
    ...
    const added = await addBookToLatest(latestBook);
    if (added) loadLatest();
  }

  async function handleRemove(book) {
    await deleteLatestBook(book.id.toString());
    loadLatest();
  }
  ...
  return (
    <div>
      ...
      <div className="container my-4">
        <h2 className="text-center mb-4">Manage Latest Books</h2>
        ...
        <div className="row">
          ...
          <div className="col-lg-6 mb-4">
            <h3 className="mb-3 border-bottom pb-1">All Latest Books</h3>
